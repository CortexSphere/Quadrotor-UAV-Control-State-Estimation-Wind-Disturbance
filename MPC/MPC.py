...
def plotOutput():
    ...
    plt.savefig("state1_with_state_limits.png")
    plt.show()
    ...
    plt.grid()
    plt.subplots_adjust(hspace=0.4)
    plt.savefig("state2_with_state_limits.png")
    plt.show()
...
def plotControlEffort():
    ...
    plt.grid()
    plt.subplots_adjust(hspace=0.4)
    plt.savefig("control_with_state_limits.png")
    plt.show()
...
ani.save('MPC_tracking_with_state_limits.gif', writer='pillow')
